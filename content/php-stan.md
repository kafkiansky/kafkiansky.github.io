...
Статический анализ в PHP – тема не сказать, что новая, но и недостаточно распространенная, чтобы перестать ее поднимать. Большинство библиотек и фреймворков либо используют статанализ только для нового кода, либо и вовсе пренебрегают им.
...
### [Итераторы](#iterators) {#iterators .header .title}
...
### [Примитивные типы](#primitive-types) {#primitive-types .header .title}
...
### [Необычные возможности](#features) {#features .header .title}
...
### [Дженерики](#generics) {#generics .header .title}
...
### [Теперь наш проект защищён от багов?](#are-we-without-bugs-now) {#are-we-without-bugs-now .header .title}
