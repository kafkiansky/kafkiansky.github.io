...
description: Статический анализ в PHP — тема не сказать чтобы новая, но и недостаточно распространенная, чтобы перестать ее поднимать. Большинство библиотек и фреймворков либо используют статанализ только для нового кода, либо и вовсе пренебрегают им.
author: kafkiansky
date: 2023-07-06
tags:
  - php
