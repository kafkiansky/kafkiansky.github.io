...
[^8]: рекомендую к прочтению этот [тред-ответ](https://groups.google.com/g/protobuf/c/UKpsthqAmjw?pli=1) на вопрос, почему группы перестали использовать. В нем много полезной философии по поводу преимуществ и недостатков обоих форматов.
